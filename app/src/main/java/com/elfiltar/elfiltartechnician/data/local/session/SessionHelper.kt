package com.elfiltar.elfiltartechnician.data.local.session
...
class SessionHelper {
    ...
    private var userSession: ProfileModel? = null
...
//        sharedPref
    ...
    fun setUserSession(fUserSession: ProfileModel) {
    ...
    fun getUserSession(): ProfileModel? {
        return Gson().fromJson(
            sharedPref!!.getString(USER_SESSION, null), ProfileModel::class.java
        )
    }
